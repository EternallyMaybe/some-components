...
<style lang="scss" scoped>
    .zm-video {
        ...
        video[isZMVideo=true]::-webkit-media-controls {
            display: none !important
        }

        video[isZMVideo=true]::-moz-media-controls {
            display: none !important
        }

        video[isZMVideo=true]::-o-media-controls {
            display: none !important
        }

        video[isZMVideo=true]::media-controls {
            display: none !important
        }
    }
